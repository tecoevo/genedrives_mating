...
%% Output
filename1 = ['fixation_prob_rand_',num2str(p_rewire),'_p_',num2str(pd),'_c_',num2str(c),'_n_',num2str(n),'_vary_theta1_trail_',num2str(sim_N),'_k_',num2str(k),'.txt'];
filename2 = ['fixation_time_rand_',num2str(p_rewire),'_p_',num2str(pd),'_c_',num2str(c),'_n_',num2str(n),'_vary_theta1_trail_',num2str(sim_N),'_k_',num2str(k),'.txt'];
filenamefig1 = ['fixation_prob_rand_',num2str(p_rewire),'_p_',num2str(pd),'_c_',num2str(c),'_n_',num2str(n),'_vary_theta1_trail_',num2str(sim_N),'_k_',num2str(k),'.eps'];
filenamefig2 = ['fixation_time_rand_',num2str(p_rewire),'_p_',num2str(pd),'_c_',num2str(c),'_n_',num2str(n),'_vary_theta1_trail_',num2str(sim_N),'_k_',num2str(k),'.eps'];
